...
21- Added stats_since and minmax_stats_since columns to all Top SQL queries in pg_stat_statements:
   - Shows when statistics were last reset for each statement (pg_stat_statements 1.11+, PG 17+)

22- Fixed bug in obsrv_less_remaining_sequences health check:
...
23- Added configurable report output directory:
...
24- Added Selective Section Execution feature:
