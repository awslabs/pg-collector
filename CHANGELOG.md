...
10- Enhanced "Temp Tables & Files" section (formerly "Temp tables"):
...
11- Enhanced "pg_stat_statements extension" section:
...
12- Added "Schema Size" subsection under "Schema Info" section:
...
13- Added "TOAST Size per Schema" subsection under "Toast Tables Mapping" section:
...
14- Added default statement_timeout of 5 minutes:
...
15- Added new "Foreign Servers" section:
...
16- Enhanced "pg_stat_all_tables order by autovacuum_count" and "autoanalyze_count" queries:
...
17- Added "Parameters pending restart" observation check and subsection under "DB parameters":
...
18- Added generic pg_stat_statements outdated check:
...
19- Added "Top SQL order by WAL Generation" subsection in pg_stat_statements:
...
20- Fixed bug in obsrv_less_remaining_sequences health check:
...
21- Added configurable report output directory:
...
22- Added Selective Section Execution feature:
